...
const HeroGradient = () => {
  return (
    <div>
      ...
      <div className="shadow-cyanMediumShadow absolute top-[300px] left-0 -z-10 opacity-90"></div>
      <div className="shadow-orangeMediumShadow absolute top-[500px] left-0 -z-10 opacity-100"></div>
    </div>
  );
};
